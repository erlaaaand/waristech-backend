...
import { DeleteStoredFileUseCase } from '../use-cases/delete-stored-file.use-case';
...
export class StorageOrchestrator {
  constructor(
    ...
    private readonly deleteStoredFile: DeleteStoredFileUseCase,
  ) {}
  ...
  delete(storedFileId: string, requestingUserId: string): Promise<void> {
    return this.deleteStoredFile.execute(storedFileId, requestingUserId);
  }
}
